...
- [x] Run `shellcheck -e SC1091` on all modified scripts (`scripts/orch-engine.sh`, `scripts/orch-review.sh`, `scripts/orch-verify.sh`, `scripts/orch-state.sh`) and fix any issues (deps: 2, 3, 6, 7)
