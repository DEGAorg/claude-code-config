...
@description Run the Canon discovery workflow to analyze prediction markets and produce a strategy design specification. Triggers on natural-language intent like "discover markets", "scan for opportunities", "analyze markets", "find a trade idea", or "design a new strategy" — selects a promising market and drafts the strategy spec that feeds `/develop`.

## When to use this skill

Invoke when the user wants to research prediction markets and design a
new strategy from scratch. Example phrases:

- "Scan Polymarket for opportunities"
- "Find me a trade idea"
- "Discover markets"
- "Design a new strategy"
- "Analyze what's moving on Kalshi today"

Do **not** invoke for bug fixes, parameter tweaks, or re-registering an
existing strategy.
