...
@description Run the Canon autonomous iteration loop — execute, check, analyze, and loop until all success criteria pass or the budget is exhausted. Triggers on natural-language intent like "ralph cycle", "run the loop", "iterate until green", "autonomous iteration", or "keep iterating until tests pass".

## When to use this skill

Invoke when the user wants autonomous iteration toward a set of
success criteria defined in `.canon/dega-core.yaml`. Example phrases:

- "Run the ralph cycle"
- "Iterate until all checks pass"
- "Keep looping until green"
- "Autonomous iteration on this task"
- "Run the loop until it ships"
