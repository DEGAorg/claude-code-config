...
@description Register a QA-approved prediction-market strategy on Canon Arena. Triggers on natural-language intent like "register my strategy", "submit to Canon Arena", "list my strategy on the leaderboard", or "ship this strategy live" — assumes a QA-approved strategy from the /develop flow and walks through risk review, a pre-registration checklist, the Arena submission, and post-registration monitoring.

## When to use this skill

Invoke this skill when the user wants to register a completed,
QA-approved strategy on Canon Arena for performance tracking. Example
phrases:

- "Register my strategy on Canon Arena"
- "Submit this strategy to the leaderboard"
- "List the strategy live"
- "Ship the strategy to Arena"
- "I'm ready to register"

Do **not** invoke this skill if the strategy has not yet gone through
`/develop` and passed QA — in that case, route to `develop` first.
