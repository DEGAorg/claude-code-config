 ...
 */
export function orderToDict(order: Order): Record<string, unknown> {
  return {
    salt: order.salt,
    maker: order.maker,
    signer: order.signer,
