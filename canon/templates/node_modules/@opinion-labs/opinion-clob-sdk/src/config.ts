...
export const SUPPORTED_CHAIN_IDS = [CHAIN_ID_BNB_MAINNET] as const;
 ...
 */
export const DEFAULT_CONTRACT_ADDRESSES: Record<
  SupportedChainId,
  {
 ...
 */
export const DEFAULT_API_HOST = 'https://openapi.opinion.trade/openapi';

/**
 * Maximum decimals for ERC20 tokens
 */
